<%-- 
    Document   : form
    Created on : 06-05-2020, 01:40:16 PM
    Author     : rey
--%>
...
<body class="row justify-content-center">
  ...
  <div class="w-25 row border border-dark justify-content-center mt-5">
    <form action="actualizarAlumno" method="post" class="my-4 col-10">

      <div class="form-group border border-dark p-2">
        <label for="">ID</label>
        <input type="text" class="form-control" id="txtId" name="txtId" value=" <%=request.getParameter("id")%>" readonly required aria-describedby="emailHelp">       
      </div>
